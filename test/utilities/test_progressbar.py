...
from mcmcplot.utilities import progressbar as pbar
import unittest
...
class IpythonProgressBarMock(unittest.TestCase):
    @patch('mcmcplot.utilities.progressbar.run_from_ipython')
...
class ConsolePrint(unittest.TestCase):
    ...
    @patch('mcmcplot.utilities.progressbar.check_windows_platform')
